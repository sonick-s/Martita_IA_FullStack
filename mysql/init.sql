...
DROP TABLE IF EXISTS `formularios_tramite`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `formularios_tramite` WRITE;
/*!40000 ALTER TABLE `formularios_tramite` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `formularios_tramite` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `pasos_tramite` WRITE;
/*!40000 ALTER TABLE `pasos_tramite` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pasos_tramite` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `prompts_bot`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `prompts_bot` WRITE;
/*!40000 ALTER TABLE `prompts_bot` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `prompts_bot` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `requisitos_tramite` WRITE;
/*!40000 ALTER TABLE `requisitos_tramite` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `requisitos_tramite` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-08-09 15:30:51
